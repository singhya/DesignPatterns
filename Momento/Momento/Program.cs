...
namespace Momento
{
    ...
    // also defines a method for saving the state inside a momento and another 
    ...
    class Originator
    {
        ...
        // Saves the current state inside a momento.
    ...
    // doesn't have access to originator's state, stored inside the memento.
